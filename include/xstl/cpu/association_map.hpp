...
namespace xstd {
  ...
  public:
    ...
    struct containers {
      ...
      explicit containers(key_type nvalues, key_type nkeys) : values(nvalues), keys(nkeys + 1) {}
    };
    ...
    explicit association_map(size_type nelements, size_type nkeys)
        : m_data(nelements, nkeys),
